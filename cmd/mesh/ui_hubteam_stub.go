...
func openHubTeam(_, _ string) (func(string) (int64, string, bool), func(int64) map[string]bool, func(int64) func(string) bool, func(int64) (string, int64, bool), *web.BrowserSignIn, func() error, error) {
	return nil, nil, nil, nil, nil, nil, errors.New("team mode (mesh ui --hub-db) needs the commercial Mesh hub build, which is not part of this open-core repository (see LICENSING.md); plain `mesh ui` serves a solo vault")
}
